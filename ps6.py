    ...
    def build_shift_dict(self, shift):
        ...
        for a in range(2):
            for i in standardlowercase:
                extendedlowercase += i
        extendeduppercase = ""
        standarduppercase = string.ascii_uppercase
        for a in range(2):
...
class PlaintextMessage(Message):
    ...
    def get_encrypting_dict(self):
        ...
        for i in self.encrypting_dict:
            copyDict[i] = self.encrypting_dict[i]
        return copyDict
    ...
    def change_shift(self, shift):
        ...
        #This basically calls the init og the class, but preserves the original message by calling the already stored text in self.message_text.
        #So, only shift is changed.
        return None
